...
{
	KokiriForestTextures[0] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texgrass_pcx);
	KokiriForestTextures[1] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texwall_pcx);
	KokiriForestTextures[2] = LoadTexture(TEXTURE_SIZE_32, (u8*)Textrunks_pcx);
	LoadAlpha = true;
	KokiriForestTextures[3] = LoadTexture(TEXTURE_SIZE_32, (u8*)Textrees_pcx);
	LoadMirrored = true;
	KokiriForestTextures[4] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texcut_pcx);
	KokiriForestTextures[5] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texhouse_pcx);
	KokiriForestTextures[6] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texbush_pcx);
	KokiriForestTextures[7] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texbushside_pcx);
	KokiriForestTextures[8] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texwalls_pcx);
	KokiriForestTextures[9] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texledge_pcx);
	KokiriForestTextures[10] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texbark_pcx);
	LoadMirrored = true;
	LoadAlpha = true;
	KokiriForestTextures[11] = LoadTexture(TEXTURE_SIZE_32, (u8*)Textreetop_pcx);
	KokiriForestTextures[12] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texexit_pcx);
	LoadMirrored = true;
	KokiriForestTextures[13] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texsteptop_pcx);
	KokiriForestTextures[14] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texstep_pcx);
	KokiriForestTextures[15] = LoadTexture(TEXTURE_SIZE_32, (u8*)Textower_pcx);
	KokiriForestTextures[16] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texenter_pcx);
	LoadAlpha = true;
	KokiriForestTextures[17] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texcurtain_pcx);
	LoadAlpha = true;
	KokiriForestTextures[18] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texvine_pcx);
	LoadAlpha = true;
	KokiriForestTextures[19] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texedge_pcx);
	LoadMirrored = true;
	KokiriForestTextures[20] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texporch_pcx);
	LoadAlpha = true;
	KokiriForestTextures[21] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texrail_pcx);
	LoadMirrored = true;
	LoadAlpha = true;
	KokiriForestTextures[22] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texladder_pcx);
	LoadAlpha = true;
	KokiriForestTextures[23] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texshroom_pcx);
	KokiriForestTextures[24] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texmido_pcx);
	KokiriForestTextures[25] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texsaria_pcx);
	KokiriForestTextures[26] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texshop_pcx);
	KokiriForestTextures[27] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texawning_pcx);
	LoadAlpha = true;
	KokiriForestTextures[28] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texfence_pcx);
	LoadAlpha = true;
	KokiriForestTextures[29] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texfencew_pcx);
	LoadMirrored = true;
	LoadAlpha = true;
	KokiriForestTextures[30] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texbridge_pcx);
	LoadAlpha = true;
	KokiriForestTextures[31] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texleaf_pcx);
	LoadAlpha = true;
	KokiriForestTextures[32] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texvineh_pcx);
	KokiriForestTextures[33] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texwater_pcx);
	KokiriForestTextures[34] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texfade_pcx);
	LoadAlpha = true;
	KokiriForestTextures[35] = LoadTexture(TEXTURE_SIZE_32, (u8*)Texvinew_pcx);
}
